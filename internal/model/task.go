...
type Task struct {
	...
	UserID      uuid.UUID  `gorm:"type:uuid;not null;constraint:OnDelete:CASCADE;foreignKey:UserID;references:ID" json:"userId" validate:"required"`
	Description string     `gorm:"not null" json:"description" validate:"required,min=3,max=200"`
